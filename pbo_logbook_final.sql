...
-- Dumping data for table logbook_skripsi.bimbingan_mahasiswa: ~10 rows (approximately)
...
-- Dumping data for table logbook_skripsi.detail_bimbingan_mahasiswa: ~20 rows (approximately)
...
-- Dumping data for table logbook_skripsi.logbook: ~12 rows (approximately)
...
-- Dumping data for table logbook_skripsi.management_pembimbing: ~27 rows (approximately)
